...
function fn_gen_doc()
{
    ...
    sed -i "s#EXCLUDE_SYMBOLS        =.*#EXCLUDE_SYMBOLS        = SHMEM_GLOBAL SHMEM_TYPE_FUNC SHMEM_TYPENAME_P_AICORE SHMEM_TYPENAME_G_AICORE SHMEM_GET_TYPENAME_MEM SHMEM_GET_TYPENAME_MEM_TENSOR SHMEM_PUT_TYPENAME_MEM SHMEM_PUT_TYPENAME_MEM_TENSOR SHMEM_GET_TYPENAME_MEM_DETAILED SHMEM_GET_TYPENAME_MEM_TENSOR_DETAILED SHMEM_PUT_TYPENAME_MEM_DETAILED SHMEM_PUT_TYPENAME_MEM_TENSOR_DETAILED dcci_cacheline addr_gm#g" $doxyfile
